  ...
  const useCases = [
    {
      ...
      image: '/venue_theater_converted.avif',
    ...
    },
    {
      ...
      image: '/festival_outdoor_converted.avif',
    ...
    },
    {
      ...
      image: '/creator_workshop_converted.avif',
  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl mx-auto px-6 sm:px-8 lg:px-16">
        {/* Heading */}
        <div className="text-center mb-10 sm:mb-12 relative z-50">
          <h2
